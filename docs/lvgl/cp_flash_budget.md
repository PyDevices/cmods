...
**Related:** `lv_mem_core_circuitpython.c`, `lv_mem_core_micropython.c`, `circuitpython.mk`, `docs/lvgl/gc_callback_audit.md`.
...
3. If tight on smaller boards later, plan `CIRCUITPY_LVGL_FULL` trim driven by `lvcp.c.json` (see `docs/lvgl/circuitpython_emit_plan.md`).

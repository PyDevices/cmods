...
Display flush/tick: **ON HOLD** — not in these C files. See `docs/lvgl/gc_callback_audit.md` and the cmods README.
...
See `docs/lvgl/circuitpython_emit_plan.md` for emission phases.
